            ...
            <div className="w-64 text-center">
              <div className="relative">
                ...
                <div className="absolute top-20 left-0 right-0 bg-white p-4 pt-12 rounded-lg shadow-md z-0">
                  <p className="font-bold text-lg mt-2">{topThree[1]?.nickname || "-"}</p>
            ...
            <div className="w-64 text-center -mt-4">
              <div className="relative">
                ...
                <div className="absolute top-24 left-0 right-0 bg-white p-4 pt-12 rounded-lg shadow-md z-0">
                  <p className="font-bold text-lg mt-2">{topThree[0]?.nickname || "-"}</p>
          ...
          {topThree.length > 2 && (
            <div className="w-64 text-center">
              <div className="relative">
                ...
                <div className="absolute top-20 left-0 right-0 bg-white p-4 pt-12 rounded-lg shadow-md z-0">
                  <p className="font-bold text-lg mt-2">{topThree[2]?.nickname || "-"}</p>
        ...
        <table className="min-w-full bg-white shadow rounded-lg">
          <thead className="bg-indigo-600 text-white">
            <tr>
              ...
              <th className="px-4 py-2 text-right">스탯 합계</th>
            </tr>
          </thead>
          <tbody>
            {restOfBoard.map((row, idx) => (
              ...
              >
                <td className="border px-4 py-2 text-center">{idx + 4}</td>
